...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('assets\User\default-img\logo-kedok-ombo.png') }}" rel="icon" type="image/png">
  {{-- <link href="{{ asset('assets\User\default-img\logo-kedok-ombo.png') }}" rel="apple-touch-icon"> --}}
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <a class="display-4" height="30px" width="30px" href="{{ URL::route('index') }}"><img src="{{ asset('assets\User\default-img\logo-kedok-ombo.png') }}" alt="Logo Kedok Ombo" class="img-fluid img-circle"></a>
        {{-- <h1 class="text-light"><a href="{{ URL::route('index') }}">SIKOMBO</a></h1> --}}
        <span class="text-light h1"><a href="{{ URL::route('index') }}">SIKOMBO</a></span>
