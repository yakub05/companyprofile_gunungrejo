...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="{{ asset('assets\User\default-img\logo-kedok-ombo.png') }}" alt="Logo Kedok Ombo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <img src="{{ Storage::url('/' . Auth::user()->AdminFoto) }}" class="img-circle elevation" alt="{{ (Auth::user()->nama) }}">
