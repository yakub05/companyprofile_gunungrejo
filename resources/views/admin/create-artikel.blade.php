            ...
            <div class="card-body">
              <div class="form-group">
                <div class="mb-3">
                  ...
                  <input class="form-control" type="file" id="ArtikelFoto" name="ArtikelFoto">
                </div> 
              </div>
              <div class="form-group">
                <label for="ArtikelJudul" class="form-label">Judul Artikel</label>
                <input type="text" id="ArtikelJudul" class="form-control" name="ArtikelJudul" required>
              </div>
              {{-- <div class="form-group">
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-5">
                  <div class="input-group date" data-provide="datepicker" data-date-format='yyyy-mm-dd'>
                    <input type="text" class="form-control" id="WaktuPembuatan" name="WaktuPembuatan" required>
